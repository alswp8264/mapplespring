            ...
            <div class="post-wrap">
                ...
                <div class="post-header">
                    ...
                    <div class="post-meta">
                        ...
                        <c:if test="${not empty notice.date_event_start}">
                            <span>
                                이벤트 기간 :
                                <c:out value="${notice.date_event_start}"/>
                                <c:if test="${not empty notice.date_event_end}">
                                    ~ <c:out value="${notice.date_event_end}"/>
                                </c:if>
                            </span>
                        </c:if>
                    </div>
                ...
                <div class="post-footer">
                    <a href="${pageContext.request.contextPath}/notice/event" class="btn btn-gray">목록으로</a>
                </div>
            </div>
        </c:when>
        <c:otherwise>
            <div class="error-msg">이벤트 정보를 불러올 수 없습니다.</div>
